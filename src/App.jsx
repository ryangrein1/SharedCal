...
// CSS variables injected into the page for full dark mode support
const injectStyles = () => {
  ...
  el.textContent = `
    ...
    * { box-sizing: border-box; }
    ...
    .plannr-cal-header-cell {
      padding: 8px 0; text-align: center;
      font-size: 12px; font-weight: 600; color: var(--text3);
      border-bottom: 1px solid var(--border2);
    }
    .plannr-cal-cell {
      min-height: 56px; padding: 3px 2px;
      border-right: 1px solid var(--border2);
      border-bottom: 1px solid var(--border2);
      cursor: pointer;
    }
    .plannr-modal-overlay {
    ...
    .plannr-group-menu {
      ...
      padding: 20px; width: 280px; z-index: 100;
    ...
    .plannr-code {
      ...
      font-size: 18px; flex: 1; text-align: center;
      font-family: monospace; border: 1.5px solid var(--border);
    }
    .plannr-tag {
...
export default function App() {
  ...
  const deleteEvent = async id => {
    ...
    catch(e) { notify("Delete failed."); await refreshEvents(); }
  };
    ...
    <div style={{ minHeight:"100vh", background:"var(--bg)" }}>
      <nav className="plannr-nav">
        ...
        <div style={{ display:"flex", gap:8, alignItems:"center" }}>
          ...
          <button className="plannr-btn-small" onClick={handleLogout}>Log out</button>
        </div>
      </nav>
      ...
      <div style={{ maxWidth:860, margin:"0 auto", padding:"16px 12px 80px" }}>
        ...
        {view==="list" && (
          <div>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:12 }}>
              ...
              <label style={{ fontSize:13, color:"var(--text3)", display:"flex", alignItems:"center", gap:6, cursor:"pointer" }}>
                <input type="checkbox" checked={showCompleted} onChange={e=>setShowCompleted(e.target.checked)} style={{ marginBottom:"0 !important" }} /> Past
              </label>
            </div>
        ...
        {view==="calendar" && (
          <div>
            ...
            <label style={{ fontSize:13, color:"var(--text3)", display:"flex", alignItems:"center", gap:6, cursor:"pointer", margin:"12px 0" }}>
  ...
  return (
    <div className="plannr-event-card" style={{ opacity:ev.completed?0.6:1, borderLeft:`4px solid ${color}` }}>
      <div style={{ display:"flex", alignItems:"flex-start", gap:10 }}>
        <input type="checkbox" checked={ev.completed} onChange={()=>onToggle(ev.id)} style={{ marginTop:4, flexShrink:0 }} />
